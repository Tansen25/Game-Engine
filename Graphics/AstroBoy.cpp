...
void AstroBoy::loadTexture( void )
{
...
void AstroBoy::loadData(const char * const inFile)
{
...
int AstroBoy::getNumVerts(void)
{
	return header.vertCount;
}

bool AstroBoy::getDuplicates(void)
{
	return duplicates;
}
...
bool AstroBoy::LoadTGATextureModel(const char *szFileName, GLenum minFilter, GLenum magFilter, GLenum wrapMode)
{
	GLbyte *pBits;
