...
void SpaceFrigate::loadTexture( void )
{
...
void SpaceFrigate::createVAO(void)
{
...
void SpaceFrigate::loadData(const char * const inFile)
{
...
int SpaceFrigate::getNumVerts(void)
{
	return header.vertCount;
}

bool SpaceFrigate::getDuplicates(void)
{
	return duplicates;
}
...
bool SpaceFrigate::LoadTGATextureModel(const char *szFileName, GLenum minFilter, GLenum magFilter, GLenum wrapMode)
{
	GLbyte *pBits;
