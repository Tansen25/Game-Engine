...
bool LoadTGATextureModel1(const char *szFileName, GLenum minFilter, GLenum magFilter, GLenum wrapMode);
...
void Model::loadTexture( void )
{
    glGenTextures(1, &this -> textureID);

	glBindTexture(GL_TEXTURE_2D, this -> textureID);
	
	LoadTGATextureModel1(header.textureName, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR, GL_CLAMP_TO_EDGE);
    
}

void Model::createVAO(void)
{
...
void Model::loadData(const char * const inFile)
{
...
int Model::getNumVerts(void)
{
	return header.vertCount;
}

bool Model::getDuplicates(void)
{
	return duplicates;
}
